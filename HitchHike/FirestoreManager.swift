...
//                }
    ...
    func fetchUpcomingTrips(userID: String, completion: @escaping ([Post]?, Error?) -> Void) {
        let now = Date()
        let postsRef = db.collection("posts")
            .whereField("userID", isEqualTo: userID)
            .whereField("pickupDate", isGreaterThan: now)
...
//        
//    func fetchPastTrips(userID: String, completion: @escaping ([Post]?, Error?) -> Void) {
//        let postsRef = db.collection("posts")
//        let now = Date()
//        
//        postsRef.whereField("userID", isEqualTo: userID)
//            .whereField("pickupDate", isLessThan: now)
...
//                }
//                
//                let trips = documents.compactMap { queryDocumentSnapshot -> Post? in
//                    let result = Result {
...
//                            .whereField("startTime", isEqualTo: startTime)
    ...
    func fetchGroupName(groupID: String, completion: @escaping(String?) -> Void) {
        let db = Firestore.firestore()
        let groupRef = db.collection("rooms").document(groupID)
